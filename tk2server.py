...
class RoomLocator(LineReceiver):
    ...
    def dataReceived(self, data):
        ...
        current_region_d = user.predictRegion(self.RSSIvalues, self.blacklist_dict, self.node_off, self.clf_room_distributed, 
                                             self.clf5300_distributed, self.clf5302_distributed, self.clf5304_distributed,
